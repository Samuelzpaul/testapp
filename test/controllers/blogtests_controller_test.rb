...
class BlogtestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogtest" do
    assert_difference('Blogtest.count') do
      post blogtests_url, params: { blogtest: { body: @blogtest.body, title: @blogtest.title } }
    end
  ...
  test "should update blogtest" do
    patch blogtest_url(@blogtest), params: { blogtest: { body: @blogtest.body, title: @blogtest.title } }
